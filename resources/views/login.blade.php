    ...
    <head>
        ...
        <style>
            ...
            .login-box {
                ...
                border-radius: 10px; /* Sudut nembulat */
                padding: 20px;
                box-shadow: 0 10px rgba(0, 0, 0, 0.2); /* Bayangan kotak */
            }
        </style>
    </head>
    <body>
        ...
        <!-- Popper JS -->
        <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/und/popper.min.js"></script>
